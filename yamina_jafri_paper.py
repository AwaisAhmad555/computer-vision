...
sample_image = cv2.imread("temporary\\segment_images\\1.png")

sample_image = np.array(sample_image,dtype=np.uint8)
#sample_image = cv2.cvtColor(sample_image,cv2.COLOR_RGB2GRAY,None)

#sample_image = sample_image/255

image_features = get_features(sample_image)
