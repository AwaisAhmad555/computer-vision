...
query_images_path = "temporary\\arabic_segment_images"
...
pickle.dump(features_list,open("temporary\\arabic_query_images_features_list.pkl","wb"))

text_dataframe = pd.read_csv("dataset\\arabic_dataset_labels.csv")

features_list = pickle.load(open("temporary\\arabic_query_images_features_list.pkl","rb"))
...
ground_truth_address = 'testing samples\\arabic\\ground_truth.txt'
